...
namespace Sprinterly.Controllers
{
    ...
    [ApiController]
    public class OldSprintStatsController : ControllerBase
    {
        private readonly IDevOpsService _devOpsService;
        private readonly ISprintStatsService _sprintStatsService;

        public OldSprintStatsController(IDevOpsService devOpsService, ISprintStatsService sprintStatsService)
        {
